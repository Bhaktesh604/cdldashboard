...
const Createnewadmin = () => {
    const initialAdmin = [
        { id: 1, name: 'Lindsay Walton', country: 'Sales', phone: '99781-41527', email: 'lindsay.walton@example.com',  user: 'Member', paymentProgress: 30 },
        { id: 2, name: 'Lindsay Walton', country: 'Marketing', phone: '99781-41527', email: 'lindsay.walton@example.com',   user: 'Member', paymentProgress: 55 },
        { id: 3, name: 'Lindsay Walton', country: 'Developer', phone: '99781-41527', email: 'lindsay.walton@example.com' , user: 'Member', paymentProgress: 75 }, 
    ];
    ...
    //     return 'bg-green-500';
    // };
    const [people, setPeople] = useState(initialAdmin);
        ...
        <div className="py-4 px-5 sm:px-6 lg:px-8 col-span-full xl:col-span-12 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
            <div className="sm:flex ">
                <div className="sm:flex-auto">
                    <h1 className="text-base font-semibold leading-6 text-gray-900">Admin List</h1> 
                </div>
