  ...
  return (
    <div>
      ...
      <div
        id="sidebar"
        ref={sidebar}
        className={`flex flex-col absolute z-40 left-0 top-0 lg:static lg:left-auto lg:top-auto lg:translate-x-0 h-screen overflow-y-scroll lg:overflow-y-auto no-scrollbar lg:w-20 lg:sidebar-expanded:!w-[230px] 2xl:!w-[230px] shrink-0 bg-white  p-4 transition-all duration-200 ease-in-out ${
            ...
            <ul className="mt-3">
                  ...
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-black truncate transition duration-150 ${
                          pathname.includes('ecommerce') ? 'hover:text-black' : 'hover:text-black'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                  ...
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-black truncate transition duration-150 ${
                          pathname.includes('community') ? 'hover:text-black' : 'hover:text-black'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                  ...
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-black truncate transition duration-150 ${
                          pathname.includes('finance') ? 'hover:text-black' : 'hover:text-black'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded ? handleClick() : setSidebarExpanded(true);
                  ...
                  return (
                    <React.Fragment>
                      <a
                        href="#0"
                        className={`block text-black truncate transition duration-150 ${
                          pathname.includes('job') ? 'hover:text-black' : 'hover:text-black'
                        }`}
                        onClick={(e) => {
                          e.preventDefault();
                          sidebarExpanded ? handleClick() : setSidebarExpanded(true);
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('calendar') && 'bg-slate-900'}`}>
                <NavLink
                  ...
                  to="/calendar"
                  className={`block text-black truncate transition duration-150 ${
                    pathname.includes('calendar') ? 'hover:text-black' : 'hover:text-black'
                  }`}
                >
                  <div className="flex items-center">
                  <svg
              ...
              <li className={`px-3 py-2 rounded-sm mb-0.5 last:mb-0 ${pathname.includes('campaigns') && 'bg-slate-900'}`}>
                <NavLink
                  ...
                  to="/customer"
                  className={`block text-black truncate transition duration-150 ${
                    pathname.includes('campaigns') ? 'hover:text-black' : 'hover:text-black'
                  }`}
                >
                  <div className="flex items-center">
                    {/* <svg className="shrink-0 h-6 w-6" viewBox="0 0 24 24">
